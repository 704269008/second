...
function projectRouteConfig($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        .state('field.dashboard', {
           ...
           //教材管理
        .state('field.wechatDataList', {
            url: '/wechatDataList',
            templateUrl: 'views/wechatDataList.html',
            controller: 'WechatDataListController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/wechatData/wechatDataListController.js'
                ])
            }
        })
        //教材编辑等管理
        .state('field.wechatDataDetails', {
            url: '/wechatDataDetails/:id',
            templateUrl: 'views/wechatDataDetails.html',
            controller: 'WechatDataDetailController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/wechatData/wechatDataDetailsController.js'
                ])
            }
        })      
