...
public class RoleModuleController {
	...
	public String getroleModuleList(HttpServletRequest request,
		...
		return "/academy-rich-admin-service/roleModule/view/roleModuleList";
	}
	...
	public String getRoleModule(HttpServletRequest request,
		...
		return "/academy-rich-admin-service/roleModule/view/roleModuleDetail";
	}
	...
	public String getRoleModuleJson(HttpServletRequest request,
		...
		return "/academy-rich-admin-service/roleModule/json/roleModuleDetailJson";
	}
	...
	public String getMultiRoleModuleJson(HttpServletRequest request,
	   ...
	   if (ids == null) {
		...
		return "/academy-rich-admin-service/roleModule/json/roleModuleListJson";
	}
