...
function projectRouteConfig($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        .state('field.dashboard', {
           ...
           //教材管理
        .state('field.roleModuleList', {
            url: '/roleModuleList',
            templateUrl: 'views/roleModuleList.html',
            controller: 'RoleModuleListController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/roleModule/roleModuleListController.js'
                ])
            }
        })
        //教材编辑等管理
        .state('field.roleModuleDetails', {
            url: '/roleModuleDetails/:id',
            templateUrl: 'views/roleModuleDetails.html',
            controller: 'RoleModuleDetailController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/roleModule/roleModuleDetailsController.js'
                ])
            }
        })      
